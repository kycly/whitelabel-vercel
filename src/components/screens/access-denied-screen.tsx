...
import { surfaceInfoPanelClassName } from "@/components/ui/fixed-action-layout";

export function AccessDeniedScreen({ userLabel }: { userLabel: string }) {
  return (
    <ProtectedScreenShell backHref="/auth/logout" title="Accès" pageClassName="flex items-center" maxWidthClassName="max-w-3xl" panelClassName="w-full text-center space-y-5 justify-center">
