# Référence — whitelabel-vercel

**Statut** : Index des documents de référence.
**Audience** : Développeurs.

| Document | Objet |
|---|---|
| [AUTH-UX.md](AUTH-UX.md) | UX de la page de connexion |
| [SESSION-CONTEXT-UX.md](SESSION-CONTEXT-UX.md) | UX du formulaire de contexte de session |
| [KYC-SESSION-CONTRACT.md](KYC-SESSION-CONTRACT.md) | Contrat de session KYC (lecture canonique `/kyclink/{id}`) |
...
| [PWA-MOBILE-FIRST-CONTRACT.md](PWA-MOBILE-FIRST-CONTRACT.md) | Contrat PWA / mobile-first |
